...
export class WingButtonCrudComponent implements OnInit {
  ...
  @Input() buttonApprove: any = { visible: false, icon: 'done', tooltip: 'Persetujuan' }
  ...
  @Input() buttonAdditional3: any = { visible: false, icon: 'archive', tooltip: 'Unduh' }
  ...
  @Output() clickApprove: EventEmitter<any> = new EventEmitter()
  ...
  onApproveClick(event: any) { this.clickApprove.emit(event) }
