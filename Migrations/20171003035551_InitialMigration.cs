        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Exact = table.Column<bool>(type: "bit", nullable: true, defaultValue:true),
                    Name = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    Icon = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    Roles = table.Column<string>(type: "nvarchar(255)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SysMenu", x => new { x.MenuId });
                }
            );

            migrationBuilder.CreateIndex(
                name: "IX_SysMenu_MenuId",
                table: "SysMenu",
                column: "MenuId");
